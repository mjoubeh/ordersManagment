	...
	<div class="wrapper" style="width:100%;">
		...
		<div id="banner" class="containe
			...
			<div id="detailsDialog">
				<div class="details-form-field">
					<table>
						...
						<tr>
							<td><label><b style="font-size:1.1em;">Customer
										ID :</b></label></td>
						...
						<tr>
							<td align="center" colspan="2">
								<button style="width: 60px; height:30px; margin-top:8px;"
									onclick="updateCustomer()" id="save">Update</button>
							</td>
						</tr>
					</table>
				</div>
			...
			<div style="position: absolute; right: 26%;">
				...
				<input type="image" class="butt" src="img/addCustomer.png"
					alt="Add Customer" onclick="addCustomer()"
