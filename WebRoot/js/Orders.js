$(function x() {
	...
	var showDetails = function(item) {
		showDetailsDialog("Order Details", item);
	}
	...
	var showDetailsDialog = function(dialogType, showItem) {
		$("#id").val(showItem.orderId);
		$("#name").val(showItem.orderName);
		$("#total").val(showItem.grandTotal);
...
function addOrder() {
	var form = $('<table>'
		...
		+ '<tr>'
		+ '<td><b>Order Name</b></td>  <td><input type="text" id="Oname" style="border-radius:3px; width:120px;"/> </td>'
		+ '</tr>'
		+ '<tr> '
		+ '<td><b>grandTotal</b></td> <td><input type="text" id="Ototal" style="border-radius:3px; width:120px;"/> </td>'
		+ '</tr>'
		+ '</table>');
	newDiv = $("<div/>");
...
function updateOrder() {
	$.getJSON('UpdateOrder', {
		...
		if (resp == 1) {
			showDialog("Order updated successfuly");
...
function addNewOrder() {
	$.getJSON('AddOrder', {
		...
		if (resp == 1) {
			showDialog("New Order added successfully");
