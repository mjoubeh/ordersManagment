		...
		<div id="header" class="container">
			...
			<div id="menu">
				<ul>
					...
					<li class="active">
					<a class="tab" href="#">Orders</a></li>

					<li><a class="tab" href="OrdersItem.jsp">&nbsp;
							&nbsp;&nbsp;&nbsp; Order Items &nbsp;&nbsp; &nbsp;</a></li>
	...
	<div class="wrapper" style="width:100%;">
		...
		<div id="banner" class="containe
			...
			<div id="detailsDialog">
				<div class="details-form-field">
					<table>
						...
						<tr>
							<td><label><b style="font-size:1.1em;">Order ID
										:</b></label></td>
						...
						<tr>
							<td><label><b style="font-size:1.1em;">Order
										Name :</b></label></td>
							<td><input id="name" name="name" type="text"
								style="background-color:white; height:33px; font-size:1em; font-weight: bold; border-radius:5px;" /></td>
						</tr>
						<tr>
							<td><label><b style="font-size:1.1em;">Grand
										Total :</b></label></td>
						...
						<tr>
							<td align="center" colspan="2">
								<button style="width: 60px; height:30px; margin-top:8px;"
									onclick="updateOrder()" id="save">Update</button>
							</td>
						</tr>
					</table>
				</div>
			...
			<div style="position: absolute; right: 26%;">
				...
				<input type="image" class="butt" src="img/addOrder.png"
					alt="Add Order" onclick="addOrder()"
